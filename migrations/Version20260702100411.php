 ...
 */
final class Version20260702100411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin CHANGE prénom prenom VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE admin CHANGE prenom prénom VARCHAR(255) NOT NULL');
